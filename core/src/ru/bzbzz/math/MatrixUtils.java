...
public class MatrixUtils {
    ...
    public static void calcTransitionMatrix(Matrix4 mat, Rect from, Rect to) {
        ...
        mat.idt().translate(to.pos.x, to.pos.y, 0f).scale(scaleX, scaleY, 1f).translate(-from.pos.x, -from.pos.y, 0f);
    }
    ...
    public static void calcTransitionMatrix(Matrix3 mat, Rect from, Rect to) {
        ...
        mat.idt().translate(to.pos.x, to.pos.y).scale(scaleX, scaleY).translate(-from.pos.x, -from.pos.y);
    }
}
